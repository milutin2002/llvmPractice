...
@.str.1 = private unnamed_addr constant [8 x i8] c"feddffd\00", align 1
...
define dso_local void @greet(ptr noundef %0) local_unnamed_addr #1 {
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  ...
  %2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef 7)
  ret i32 0
}
